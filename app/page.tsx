  ...
  const renderCard = (product: any) => (
    <div key={product.id} className="group relative w-60 h-80 shadow-lg rounded-lg overflow-hidden transform transition-transform duration-300 ease-in-out hover:scale-105">
      ...
      <div className="flex flex-col justify-center items-center text-center gap-3 p-4">
        <h3 className="text-[#FA8728] text-lg font-semibold">{product.title}</h3>
  ...
  return (
    ...
    <div>
      <Head>
        ...
        <meta name="description" content="En kaliteli lastik ve araç parçalarını uygun fiyatlarla online satın alabilirsiniz." />
        <meta name="keywords" content="lastik, yaz lastiği, kış lastiği, araç parçaları, jant, akü, e-ticaret" />
        <meta property="og:title" content="Lastik ve Araç Parçaları - E-Ticaret Sitesi" />
        <meta property="og:description" content="En kaliteli lastik ve araç parçalarını uygun fiyatlarla online satın alabilirsiniz." />
      </Head>
      ...
      <div className="container mx-auto p-7 flex-grow bg-[#FA8728] rounded-lg text-white">
        <div>
          <h1 className="text-3xl font-bold">Aracınıza En Uygun Lastiği Bulun!</h1>
          <p className="text-lg">
      ...
      <div className="container mx-auto p-6 flex-grow ">
          <div className="flex flex-col justify-center items-center py-8">
            <h2 className="text-3xl font-bold text-center relative group text-black">
            Çok Satanar
      ...
      <div className="bg-[#053C50]">
        <div className="container mx-auto flex-grow rounded-lg pt-16">
          <div className="flex flex-col justify-center items-center py-8">
            <h2 className="text-3xl font-bold text-center relative group text-white">
              Popüler Markalar
              <div className="border-t-3 rounded-lg border-[#FA8728] absolute bottom-[-18px] left-1/2 transform -translate-x-1/2 transition-all group-hover:scale-x-100 group-hover:w-full w-20 origin-center"></div>
            </h2>
          </div>
      ...
      <div className="container mx-auto flex-grow flex flex-col md:flex-row gap-6 py-3">
        ...
        <div className="flex-1 p-4">
          ...
          <h3 className="text-3xl font-bold text-center relative group text-black">
            Sık Sorulanlar
              <div className="border-t-3 rounded-lg border-[#FA8728] absolute bottom-[-18px] left-1/2 transform -translate-x-1/2 transition-all group-hover:scale-x-100 group-hover:w-full w-20 origin-center"></div>
            </h3>
          </div>
      ...
      <div className="resimm">
        <div className="container mx-auto py-20 ">
          ...
          <h3 className="text-white text-3xl font-bold mt-20">
