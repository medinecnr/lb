      ...
      <div className="container mx-auto relative ">
        <div className="my-6">
          <Breadcrumbs>
            ...
            <BreadcrumbItem href="/urun-detay" className='hidden sm:block'>235/65R16C 12PR 121/119N Lassa Wintus 2 M+S</BreadcrumbItem>
          </Breadcrumbs>
        </div>
              ...
              <div className="flex justify-between items-center">
                <div className="flex justify-start items-center gap-2">
                  <Tooltip
                    ...
                    placement="left"
                  >
                    <button className="border rounded-xl w-10 h-10">
