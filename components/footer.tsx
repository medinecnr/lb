    ...
    <div className="bg-[#053C50] text-white py-8">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-start max-w-7xl">
        <div className="flex-1 p-4 mb-6 md:mb-0 md:w-1/3">
          <h1 className="text-xl mb-6">Lastik Borsası</h1>
          ...
          <div className="mt-16">
            <h1 className="text-xl">Bize Ulaşın</h1>
        ...
        <div className="w-full md:w-1/3 p-4 flex flex-col items-center md:items-start">
          <h1 className="text-xl mb-6 flex items-center cursor-pointer" onClick={() => setIsSizeOpen(!isSizeOpen)}>
        ...
        <div className="w-full md:w-1/3 p-4 flex flex-col items-center md:items-start">
          <h1 className="text-xl mb-6 flex items-center cursor-pointer" onClick={() => setIsBrandOpen(!isBrandOpen)}>
            Popüler Markalar
        ...
        <div className="w-full md:w-1/3 p-4 flex flex-col items-center md:items-start">
          <h1 className="text-xl mb-6 flex items-center cursor-pointer" onClick={() => setIsCategoryOpen(!isCategoryOpen)}>
            Kategoriler
